...
![screenshot_20170127-170618 1](https://cloud.githubusercontent.com/assets/13764097/22370581/1d22a8b0-e4b8-11e6-9b79-cb52f4d76366.png)
...
<de.hdodenhof.circleimageview.CircleImageView
    ...
    app:civ_blur_radius="20"/>
```
Note
----
```xml
    app:civ_blur_radius     can have values from 0-25
```
...
* Using blur_radius or setBlurRadius(float blurRadius), only works from api 18+ and works for blur_radius 0-25.

Changelog
---------
* **2.1.1**
    * Add support for blur image background
* **2.1.0**
